					...
					<div className="flex flex-col gap-3 md:w-1/2">
						<div className="flex flex-col gap-1">
							<input
								...
								onChange={(e) =>
									feedbackForm.handleChange(
										"name",
										e.target.value
									)
								}
								className={`rounded-lg px-4 py-2 w-full bg-[#FFFFFF] text-[#868686] border ${
				...
				<div className="flex flex-col md:flex-row md:justify-between items-start gap-10 mt-10">
					...
					<div className="order-2 md:order-1 flex flex-row md:flex-col gap-25 md:gap-10 md:w-1/2">
						<div className="flex flex-col md:items-start mb-4 md:mb-0 md:max-w-lg">
							<p className="text-sm text-[#868686] font-bold">
								{t("address_title")}
							</p>
							<p className="text-sm md:text-2xl text-[#03156B]">
								{t("address_text")}
							</p>
						</div>
						...
						<div className="flex flex-col">
							...
							<div className="flex gap-4 text-[#03156B] text-xl mt-2">
								<a href="https://www.youtube.com/@TESPACKUZ">
									<FaYoutube />
								</a>
								{/* <a href="#">
									<FaFacebookF />
