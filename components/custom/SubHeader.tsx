...
//         { href: "/company/activity", label: "Деятельность" },
//         { href: "/company/facts", label: "Факты" },
//         { href: "/company/advantages", label: "Преимущества" },
//     ];
...
//                     {currentPage ? `${currentPage.label} Tespak` : "Tespak"}
//                 </h2>
