    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <span className="pointer-events-none">
          <CiCirclePlus className="block group-data-[state=open]:hidden size-8 text-[#071A34]" />
          <CiCircleMinus className="hidden group-data-[state=open]:block size-8 text-[#062BD9]" />
        </span>
      </AccordionPrimitive.Trigger>
