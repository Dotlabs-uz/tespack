...
//         "https://tespack.uz/wp/wp-json/wp/v2/products?_embed&per_page=100",
//         { next: { revalidate: 60 } }
//     );
//     if (!res.ok) return [];
//     return res.json();
...
//                             ПЭТ-Контейнеры
//                         </h2>
//                         <MdKeyboardArrowDown className="h-5 w-5 text-[#03156B] cursor-pointer" />
//                     </CollapsibleTrigger>
//                     <CollapsibleContent className="mt-3 flex flex-col gap-2">
//                         {[
//                             "noncarbonated", "sensitive", "sparkling", "low-calorie", "organic", "sugar-free", "flavored", "caffeine-free",
//                         ].map((option, i) => (
//                             <label
//                                 key={i}
...
//                     </CollapsibleTrigger>
//                     <CollapsibleContent className="mt-3 flex flex-col gap-2">
//                         {["noncarbonated", "sensitive", "sparkling", "low-calorie"].map(
//                             (option, i) => (
//                                 <label
//                                     key={i}
//                                     className="flex items-center gap-2 text-sm"
...
//                                 className="rounded-2xl transition flex items-center justify-center h-[330px]"
//                                 style={{
//                                     boxShadow:
